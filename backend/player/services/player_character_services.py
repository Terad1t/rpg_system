...
def get_player_character(db: Session, character_id: int, user_id: int):
...
def update_player_character(db: Session, character_id: int, user_id: int, character_update: CharacterUpdateByPlayer):
...
def get_all_player_characters(db: Session, user_id: int):
